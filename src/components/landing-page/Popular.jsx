...
export default function Popular() {
  const items = [
    { image: "/coffee/caramel.jpg", cost: 340, name: "caramel frappuccino" },
    { image: "/coffee/cappuccino.jpg", cost: 270, name: "cappuccino" },
    { image: "/coffee/mocha.jpg", cost: 340, name: "mocha frappuccino" },
    { image: "/coffee/latte.jpg", cost: 290, name: "latte" },
    { image: "/coffee/smoothie.jpg", cost: 370, name: "cocoa smoothie" },
    { image: "/coffee/iced.jpg", cost: 370, name: "iced frappuccino" },
  ];
