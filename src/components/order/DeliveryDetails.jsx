...
function DeliveryDetails({ children, location }) {
...
function Submit({ children }) {
  const { formHandler } = useContext(DeliveryDetailsContext);
...
DeliveryDetails.Submit = Submit;
DeliveryDetails.InputFields = InputFields;
DeliveryDetails.Logout = Logout;
